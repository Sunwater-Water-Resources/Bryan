...
class D50Weighting:
    ...
    def __init__(self, filepath, pattern_type, duration, pattern_area=100):
        self.filepath = filepath
        self.pattern_type = pattern_type
        # If GTSMR patterns are not being run: pattern_area = 0
        # and the weighting table query will fail on GTSMR lookup.
        # So, workaround is to set default to 100 km² to load a
        # dummy set of weightings for the GTSMR method
        if pattern_area < 100:
            pattern_area = 100
