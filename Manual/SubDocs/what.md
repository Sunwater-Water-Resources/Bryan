# What Bryan does
The code has been set up to run URBS and RORB models through either a monte carlo or ensemble scheme. The sampling for the monte carlo scheme includes:
...
- **Initial losses** are randomly scaled according to empirical data in ARR.
